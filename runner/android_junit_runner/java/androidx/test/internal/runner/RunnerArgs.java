...
public class RunnerArgs {
  ...
  // be removed in a few days. Depending on this flag is discouraged and dependents will not be
  // supported.
  static final String ARGUMENT_TEST_PLATFORM_MIGRATION = "testPlatformMigration";
